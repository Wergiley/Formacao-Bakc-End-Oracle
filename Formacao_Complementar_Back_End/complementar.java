...
/* Conteúdos Complemetares da Formação Back-End: 2h 38min */ 
// O que são Enums no Java? Aula: 16:55min
// O que são Anotações no Java? Aula: 22:36min
// Dominando a JVM e o Java. Aula: 14:56min
// Novidades do Java 9 e para frente. Aula: 8:58min
// O que é ACID? Aula: 8:32min
// ORM: O que é? Aula: 3:09min
// Como instalar o MySQL no Linux. Aula: 7:01min
// Injeção de dependências: O que é? Aula: 13:10min
// O que é REST? Aula: 13:20min
// O que é Json Web Token (JWT)? Aula: 9:30min
// Testes de API com Postman. Aula: 15:02min
// Documentando suas APIs com Swagger.  Aula: 12:11min

// Java e JDBC: trabalhando com um banco de dados: 10h
